...
//    }
    ...
    @Nested
    inner class GetShortestPresses {
        @Test
        fun `start on up, press left`() {
            assertThat(directionPad.getShortestKeysForPress('^', '<'))
                .isEqualTo(
                    listOf(
                        listOf('v', '<', 'A')
                    )
        ...
        @Test
        fun `start on left, press A`() {
            assertThat(directionPad.getShortestKeysForPress('<', 'A'))
                .isEqualTo(
                    listOf(
                        listOf('>', '>', '^', 'A')
                    )
        ...
        @Test
        fun `start on 4, press 0`() {
            assertThat(numberPad.getShortestKeysForPress('4', '0'))
                .isEqualTo(
                    listOf(
                        listOf('>', 'v', 'v', 'A')
                    )
        ...
        @Test
        fun `start on A, press 1`() {
            assertThat(numberPad.getShortestKeysForPress('A', '1'))
                .isEqualTo(
                    listOf(
                        listOf('^', '<', '<', 'A')
                    )
